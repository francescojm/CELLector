...
To R package is available on github at https://github.com/francescojm/CELLector. We rocommend to use it within Rstudio (https://www.rstudio.com/). To install it the following commands should be executed:
...
Full documentation of the package available at: https://github.com/najha/CELLector/blob/master/CELLector.pdf
